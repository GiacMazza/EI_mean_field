  ...
  do ihf=1,size(phi_list)
     ...
     do jhf=1,Nhf
        ...
        if(lgr_fix_phase) then        
           ...
           lgr_iter_tmp(1)=dreal(lgr_iter)
           lgr_iter_tmp(2)=dimag(lgr_iter)
...
contains
  ...
  function fix_lgr_params(x) result(out_x)
    ...
    real(8) :: xmu_lgr
    complex(8) :: phi_tmp(4),lgrx,phi_out
