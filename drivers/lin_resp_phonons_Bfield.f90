program officina
  ...
  call parse_input_variable(ihf_print,"ihf_print","input.conf",default=1)
  ...
  !+- solve the equilibrium hamiltonian upon reading the solution -+!
